...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">OpenFOAM</h2>
    <p class="mt-1 text-gray-600 dark:text-gray-400">Collecting metrics from CFD simulations</p>
  </div>
