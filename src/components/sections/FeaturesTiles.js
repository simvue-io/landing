      ...
      <div className="container">
        <div className={innerClasses}>
          <div className={tilesClasses}>
            ...
            <div className="tiles-item reveal-from-bottom pt-16">
...
Monitor simulations running anywhere in the world using a simple Python client.
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="mb-16">
                    <Image
                      src={require('./../../assets/images/share-2.svg')}
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
Collect arbitrary metadata and categorise simulations using tags. 
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="200">
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  <div className="mb-16">
                    <Image
                      src={require('./../../assets/images/database.svg')}
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
Store software, input and output files or even intermediate files. 
                    </p>
                </div>
              </div>
            </div>
